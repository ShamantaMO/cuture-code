...
export class JewelsController {
  ...
  @ApiCreatedResponse({ type: ResponseCreateJewelsDoc })
  @ApiNotFoundResponse({
    example: `Este produto com o ID: 9 não foi encontrado!`,
  })
  @ApiForbiddenResponse({ example: { message: 'Token não encontrado' } })
  @Get(':id')
