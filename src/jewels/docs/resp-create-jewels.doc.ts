...
export class ResponseCreateJewelsDoc extends CreateJewelsDoc {
  ...
  @ApiProperty({ description: 'jewel creation date', type: Date, example: new Date(), name: 'createdAt' })
  createdAt: Date;
  
  @ApiProperty({ description: 'jewel updated date', type: Date, example: new Date(), name: 'updatedAt' })
  updatedAt: Date;
}