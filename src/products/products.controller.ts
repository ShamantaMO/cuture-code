...
import { UsersDecorator } from 'src/users/users-decorator';
...
export class ProductsController {
  ...
  @ApiForbiddenResponse({ example: { message: 'Token não encontrado' } })
  @ApiNotFoundResponse({
    example: `Este produto com o ID: 7 não foi encontrado ou está sem estoque`,
  })
  @ApiBadRequestResponse({ example: 'Insufficient jewels' })
  @Post('reward/:id')
  async reward(
    @Param('id', ParseIntPipe) id: number,
    @UsersDecorator() userDeco: UsersDecoratorDTO,
  ) {
  ...
  @ApiForbiddenResponse({ example: { message: 'Token não encontrado' } })
  @ApiNotFoundResponse({
    example: `Este produto com o ID: 8 não foi encontrado ou está sem estoque`,
  })
  @Get(':id')
  ...
  @ApiForbiddenResponse({ example: { message: 'Token não encontrado' } })
  @ApiNotFoundResponse({
    example: `Este produto com o ID: 9 não foi encontrado ou está sem estoque`,
  })
  @Roles(RoleEnum.admin)
  @Patch(':id')
  async update(
  ...
  @ApiForbiddenResponse({ example: { message: 'Token não encontrado' } })
  @ApiNotFoundResponse({
    example: `Este produto com o ID: 3 não foi encontrado ou está sem estoque`,
  })
  @Roles(RoleEnum.admin)
  @Delete(':id')
